...
const TAGS = [
  ...
  { key: "dd", title: "<dd>", desc: "Define a descrição (definição) de um termo em uma lista de definições (usado dentro de <dl>).", example: `<dl>\n  <dt>CSS</dt>\n  <dd>Folhas de estilo para aparência da página.</dd>\n</dl>`, keywords: ["dd", "definicao", "definição", "descricao do termo", "descrição do termo", "definition description"]},
  { key: "menu", title: "<menu>", desc: "Representa uma lista de comandos/ações. Hoje é pouco usada; na prática, <ul>/<ol> são mais comuns.", example: `<menu>\n  <li><button type="button">Salvar</button></li>\n  <li><button type="button">Editar</button></li>\n</menu>`, keywords: ["menu", "lista de comandos", "comandos", "acoes", "ações", "toolbar", "lista", "lista de menu"]},
